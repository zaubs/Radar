...
def Parse(folder, filename, rawcheck = False):
    ...
    with open(path, 'r') as data:
        ...
        for row in data:
            ...
            # defining variables
                ...
                # use this branch to get all raw data
                # else:
    ...
    return parent_dict, clean_data, rawcheck # dictionary of clean echo data, number of clean files (with and without defined coordinates)
...
def clean_echoes(parent, num_locs_init, date, folder, filename, num_dr, num_da, method=vel_check):
    ...
    with open(path, "w") as clean_data:
        ...
        if method == 'raw data':
            ...
            clean_data.write(f"{'Date':>12} {'Time':>8} {'Number of Stations':>12} {'R0':>8} {'Theta':>8} {'Phi':>8} {'vel_m':>10} {'vel_ptn0':>10} {'vel_geo':>10} {'Ecliptic Lambda':>10} {'Ecliptic Beta':>10} {'Solar Longitude':>10}\n\n")
            
            for key, value in parent.items():
                clean_data.write(f"{value['date']:>12} {value['time']:>8} {value['Number of Stations']:>12} {value['R0']:>8} {value['Theta']:>8} {value['Phi']:>8} {value['Time of flight velocity']:>10} {value['Pre-t0 velocity']:>10} {value['Geocentric velocity']:>10} {value['Ecliptic longitude']:>10} {value['Ecliptic latitude']:>10} {value['Solar longitude']:>10}\n")
        ...
        if method == vel_check:
            ...
            clean_data.write(f"{'Date':>12} {'Time':>8} {'Number of Stations':>12} {'R0':>8} {'Theta':>8} {'Phi':>8} {'vel_m':>10} {'vel_ptn0':>10} {'vel_geo':>10} {'Percent difference':>10} {'Ecliptic Lambda':>10} {'Ecliptic Beta':>10} {'Solar Longitude':>10}\n\n")
            
            for key, value in parent.items():
                clean_data.write(f"{value['date']:>12} {value['time']:>8} {value['Number of Stations']:>12} {value['R0']:>8} {value['Theta']:>8} {value['Phi']:>8} {value['Time of flight velocity']:>10} {value['Pre-t0 velocity']:>10} {value['Geocentric velocity']:>10} {value['Percent difference']:>10.2f} {value['Ecliptic longitude']:>10} {value['Ecliptic latitude']:>10} {value['Solar longitude']:>10}\n")
            ...
            clean_data.write(f"{'Date':>12} {'Time':>8} {'Number of Stations':>12} {'R0':>8} {'Theta':>8} {'Phi':>8} {'vel_m':>10} {'vel_ptn0':>10} {'vel_geo':>10} {'Interferometry Error':>10} {'Ecliptic Lambda':>10} {'Ecliptic Beta':>10} {'Solar Longitude':>10}\n\n")
            
            for key, value in parent.items():
                clean_data.write(f"{value['date']:>12} {value['time']:>8} {value['Number of Stations']:>12} {value['R0']:>8} {value['Theta']:>8} {value['Phi']:>8} {value['Time of flight velocity']:>10} {value['Pre-t0 velocity']:>10} {value['Geocentric velocity']:>10} {value['Interferometry Error']:>10} {value['Ecliptic longitude']:>10} {value['Ecliptic latitude']:>10} {value['Solar longitude']:>10}\n")
            ...
            clean_data.write(f"{'Date':>12} {'Time':>8} {'Number of Stations':>12} {'R0':>8} {'Theta':>8} {'Phi':>8} {'vel_m':>10} {'vel_ptn0':>10} {'vel_geo':>10} {'Solid Angle Error':>10} {'Ecliptic Lambda':>10} {'Ecliptic Beta':>10} {'Solar Longitude':>10}\n\n")
            
            for key, value in parent.items():
                clean_data.write(f"{value['date']:>12} {value['time']:>8} {value['Number of Stations']:>12} {value['R0']:>8} {value['Theta']:>8} {value['Phi']:>8} {value['Time of flight velocity']:>10} {value['Pre-t0 velocity']:>10} {value['Geocentric velocity']:>10} {value['Solid Angle Error']:>10} {value['Ecliptic longitude']:>10} {value['Ecliptic latitude']:>10} {value['Solar longitude']:>10}\n")
            ...
            clean_data.write(f"{'Date':>12} {'Time':>8} {'Number of Stations':>12} {'R0':>8} {'Theta':>8} {'Phi':>8} {'vel_m':>10} {'vel_ptn0':>10} {'vel_geo':>10} {'Station Measurement Error':>10} {'Ecliptic Lambda':>10} {'Ecliptic Beta':>10} {'Solar Longitude':>10}\n\n")
...
def echo_plot(lmda, beta, year, month=None, mode='year'):
...
def echo_3d_plot(lmda, beta, vels, year, month=None, mode='month'):
            ...
            with open(month_file_path, 'r') as month_data:
                for line in month_data:
                    ...
                    if params == []:
                        ...
                        velg = params[8] # same index for all three cases

                        # indices of eclitpic coodinates, currently dependent on which filter method is being used
...
if len(folder) == 0:
    ...
    for file in folder:
        ...
        # Parse function call
        parent_dict, num_clean, rawcheck = Parse(folder_name, file, rawcheck=False) # num clean being written as pre duplicate number of events
        ...
        # this one is for when filters are being used
        else:
        ...
        num_echo_locs += clean_echoes(parent_new, num_clean, orb_date, folder_name, file, dr, da, method='all checks')
...
# calling the overplot function here; not using it currently
# overplot()
